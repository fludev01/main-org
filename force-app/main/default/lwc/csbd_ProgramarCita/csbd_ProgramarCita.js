...
import {errorApex, publicarEvento, toast, transitionThenCallback} from 'c/demo_lwcUtils';
import {cambiarSeccion} from './utils';

import programarCitaApex from '@salesforce/apex/demo_ProgranarCitaApex.programarCita';
...
const OPPTY_FIELDS = [OPPTY_OWNER_ID, OPPTY_OWNER_PROFILE_NAME];
